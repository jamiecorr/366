...
DROP TABLE IF EXISTS cpe366.Link;
DROP TABLE IF EXISTS cpe366.EmailEvent;
DROP TABLE IF EXISTS cpe366.EmailSentTo;
DROP TABLE IF EXISTS cpe366.Email;
DROP TABLE IF EXISTS cpe366.EmailCampaign;
DROP TABLE IF EXISTS cpe366.Purchase;
DROP TABLE IF EXISTS cpe366.EmailAddress;
DROP TABLE IF EXISTS cpe366.Domain;
DROP TABLE IF EXISTS cpe366.Customer;
